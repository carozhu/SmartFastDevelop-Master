...
public class CommonTabActivity extends AppCompatActivity {
    ...
    private String[] mTitlesL4 = {"首页首页", "消息消息"};
    ...
    private ArrayList<CustomTabEntity> mTabEntitiesL4 = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < mTitlesL4.length; i++) {
            mTabEntitiesL4.add(new TabEntity(mTitlesL4[i], mIconSelectIds[i], mIconUnselectIds[i]));
        }
...
//        MsgView mTr = mTabLayout_4.getMsgView(1);
//        if (mTr != null) {
//            UnreadMsgUtils.setSize(mTr, dp2px(8.0f));
//        }
        ...
        mTabLayout_4.showMsg(1, 100);
        mTabLayout_5.showMsg(1, 100);
        mTabLayout_6.showMsg(1, 100);
