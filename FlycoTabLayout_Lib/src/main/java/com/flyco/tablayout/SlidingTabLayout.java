...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private static final int SCROLL_STYLE_GO_WITH_INDICATOR = 0;
    private static final int SCROLL_STYLE_CENTER = 1;
    private int mIndicatorScrollStyle = SCROLL_STYLE_CENTER;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorScrollStyle = ta.getInt(R.styleable.SlidingTabLayout_tl_indicator_scroll_style, SCROLL_STYLE_CENTER);
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    /**
     * HorizontalScrollView滚到当前tab,并且是否居中显示
     */
    private void scrollToCurrentTab() {
        ...
        if (mIndicatorScrollStyle == SCROLL_STYLE_CENTER) {
        ...
        } else if (mIndicatorScrollStyle == SCROLL_STYLE_GO_WITH_INDICATOR){
            if (mCurrentTab > 0 || offset > 0) {
                /**HorizontalScrollView移动到当前tab,并居中*/
                newScrollX -= getWidth() / 2 - getPaddingLeft();
                calcIndicatorRect();
