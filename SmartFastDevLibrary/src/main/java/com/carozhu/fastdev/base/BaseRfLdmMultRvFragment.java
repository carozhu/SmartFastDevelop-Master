 ...
 */
public abstract class BaseRfLdmMultRvFragment<P extends BasePresenter, V extends IContractView, RV extends RecyclerView, swipeRefreshLayout extends SwipeRefreshLayout, multiStateView extends MultiStateView>
        extends BaseLazyLoadFragment<P, V>
        implements SwipeRefreshDelegate.OnSwipeRefreshListener, LoadMoreDelegate.LoadMoreSubject {

    private String TAG = BaseRfLdmMultRvFragment.class.getSimpleName();
