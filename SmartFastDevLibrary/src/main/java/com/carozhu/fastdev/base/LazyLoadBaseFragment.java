 ...
 */
public abstract class LazyLoadBaseFragment<P extends BasePresenter, V extends IContractView> extends BaseLifeCircleFragment implements IFragment<P> {
    private String TAG = LazyLoadBaseFragment.class.getSimpleName();
