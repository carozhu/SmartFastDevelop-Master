 ...
 * Author: carozhu
 * Date  : On 2018/9/28
 * Desc  : copy from  https://github.com/jcsla/BottomNavigationViewEx
 * Modiy : carozhu 支持API28 不采用 api 'com.google.android.material:material:1.0.0'
 * 以下版本适配28，测试有问题
 */
...
//        mSet.addListener(new android.support.transition.Transition.TransitionListener() {
//            @Override
...
//        //getBottomNavigationItemView(position).setShifting(enable);//Api 28
//        getBottomNavigationItemView(position).setShiftingMode(enable);//Api 27
//    }
//
