...
public class FlowLayout extends ViewGroup {
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        for (int i = 0; i < a.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.FlowLayout_verticalSpacing) {
                mVerticalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_verticalSpacing, 5);

            } else if (attr == R.styleable.FlowLayout_horizontalSpacing) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (childWidth + childLeft + getPaddingRight() > widthSize) {
                ...
                childLeft = getPaddingLeft() + childWidth + mHorizontalSpacing;// 重新开启新行，开始记录childLeft
